    ...
    private var marketStatsSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            LazyVGrid(columns: columns, alignment: .leading, spacing: 12) {
                statCell(title: "Global Market Cap", value: marketVM.globalMarketCapFormatted, icon: "globe")
                statCell(title: "24h Volume", value: marketVM.volume24hFormatted, icon: "clock")
                statCell(title: "BTC Dominance", value: marketVM.btcDominanceFormatted, icon: "bitcoinsign.circle")
                statCell(title: "ETH Dominance", value: marketVM.ethDominanceFormatted, icon: "chart.bar.xaxis")
            }
        }
        .padding(.vertical, 12)
        .padding(.horizontal, 16)
